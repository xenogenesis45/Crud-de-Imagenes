...
var controller_index_1 = require("../controller/controller_index");
...
var fileUpload = multer_1.default({
    storage: diskstorage
}).single('images');
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.router.get('/', function (req, res) {
                    ...
                    controller_index_1.indexController.index;
                });
                return [2 /*return*/];
            });
        });
...
exports.default = exports.indexRoute.router;
